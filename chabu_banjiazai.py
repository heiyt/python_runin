...
#半加载插补法，对于第一象限的逆圆，5位寄存器！！！起点为A(i,0)，终点为B(0,i)
...
def main():
        ...
        while jex>0:
            ...
            if jrx>31:
                ...
                yx="0  "
            print('{:02d}'.format(num),to_bin(jvx,5)," ",to_bin(jrx,5)," ",yx," ",to_bin(jex,3),end=" ")
            num=num+1
            if jey>0:
                jry=jvy[0]+jry
                if jry>31:
            ...
            print(to_bin(jvy[0],5)," ",to_bin(jry,5)," ",yy," ",to_bin(jey,3))
            jvy[0]=jvy[1]
...
if __name__ == '__main__':
        print("半加载插补法，对于第一象限的逆圆，起点为A(i,0)，终点为B(0,i)\n下面输入",end="")
